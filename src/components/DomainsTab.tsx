  ...
  const domains = [
    {
      ...
      icon: (
        <svg className="w-16 h-16 text-[var(--clr-primary)] transition-transform duration-500 group-hover:scale-110" viewBox="0 0 100 100" fill="none">
          ...
          <circle cx="20" cy="80" r="4.5" fill="var(--clr-primary)" stroke="#FFFFFF" className="dark:stroke-slate-950" strokeWidth="1.5" />
          <circle cx="50" cy="38" r="4.5" fill="var(--clr-primary)" stroke="#FFFFFF" className="dark:stroke-slate-950" strokeWidth="1.5" />
          <circle cx="90" cy="35" r="6.5" fill="var(--clr-primary)" stroke="#FFFFFF" className="dark:stroke-slate-950 animate-pulse" strokeWidth="2" />
          <defs>
    ...
    },
    {
      ...
      icon: (
        <svg className="w-16 h-16 text-[var(--clr-primary)] transition-transform duration-500 group-hover:scale-110" viewBox="0 0 100 100" fill="none">
          ...
          <circle cx="50" cy="50" r="9.5" fill="url(#logical-grad)" stroke="#FFFFFF" className="dark:stroke-slate-950 filter drop-shadow-[0_0_6px_rgba(var(--clr-primary-rgb),0.4)]" strokeWidth="2" />
          <circle cx="25" cy="30" r="5" fill="var(--clr-primary)" stroke="#FFFFFF" className="dark:stroke-slate-950" strokeWidth="1.5" />
          <circle cx="75" cy="30" r="5" fill="var(--clr-primary)" stroke="#FFFFFF" className="dark:stroke-slate-950" strokeWidth="1.5" />
          <circle cx="25" cy="70" r="5" fill="var(--clr-primary)" stroke="#FFFFFF" className="dark:stroke-slate-950" strokeWidth="1.5" />
          <circle cx="75" cy="70" r="5" fill="var(--clr-primary)" stroke="#FFFFFF" className="dark:stroke-slate-950" strokeWidth="1.5" />
          <defs>
    ...
    },
    {
      ...
      icon: (
        <svg className="w-16 h-16 text-[var(--clr-primary)] transition-transform duration-500 group-hover:scale-110" viewBox="0 0 100 100" fill="none">
          <rect x="15" y="25" width="50" height="20" rx="7" className="fill-[var(--clr-primary)]/10" stroke="var(--clr-primary)" strokeWidth="1.8" />
          <text x="24" y="38" className="fill-[var(--clr-primary)] dark:fill-[var(--clr-primary)] font-extrabold" fontSize="9" fontWeight="800" fontFamily="system-ui, sans-serif" letterSpacing="0.5">SYNTAX</text>
          <rect x="35" y="52" width="50" height="20" rx="7" fill="url(#verbal-grad)" className="stroke-white dark:stroke-slate-900 filter drop-shadow-[0_4px_8px_rgba(var(--clr-primary-rgb),0.2)]" strokeWidth="1.5" />
    ...
    },
    {
      ...
      icon: (
        <svg className="w-16 h-16 text-[var(--clr-primary)] transition-transform duration-500 group-hover:scale-110" viewBox="0 0 100 100" fill="none">
          <path d="M 28 32 L 10 50 L 28 68" stroke="var(--clr-primary)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M 72 32 L 90 50 L 72 68" stroke="var(--clr-primary)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          <line x1="56" y1="26" x2="44" y2="74" stroke="var(--clr-primary)" strokeWidth="3" strokeLinecap="round" />
          <circle cx="50" cy="16" r="3" fill="var(--clr-primary)" />
          <circle cx="15" cy="80" r="3" fill="var(--clr-primary)" />
          <circle cx="85" cy="80" r="3" fill="var(--clr-primary)" />
        </svg>
      )
    }
  ];
