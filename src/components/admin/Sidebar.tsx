...
export default function Sidebar({ activeId, onSelectTab }: SidebarProps) {
  return (
    <aside className="w-64 bg-slate-50 border-r border-slate-200/80 flex flex-col h-screen shrink-0">
      ...
      <div className="p-6 border-b border-slate-200/60 flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <span className="font-semibold text-slate-900 tracking-tight text-[15px] leading-tight">System Admin</span>
          <span className="text-[10px] font-bold text-slate-400 tracking-wider uppercase mt-0.5">Institutional Access</span>
        </div>
      </div>
