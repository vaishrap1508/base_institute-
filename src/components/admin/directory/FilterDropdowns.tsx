  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative w-full">
        <Search className="w-5 h-5 text-slate-500 dark:text-slate-400 absolute left-4.5 top-1/2 -translate-y-1/2 pointer-events-none" />
        <input
          type="text"
          value={searchQuery}
          onChange={(e) => setSearchQuery(e.target.value)}
          placeholder="Search questions, concepts, IDs, or company tags..."
          className="w-full pl-12 pr-4 py-3.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-sm text-slate-950 dark:text-slate-100 placeholder:text-slate-500 dark:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 shadow-sm transition-all"
        />
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-5 shadow-xs flex flex-wrap items-end gap-4.5">
        ...
        <div className="flex-1 min-w-[170px] flex flex-col gap-1.5">
          <span className="text-[10px] font-extrabold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wider">Domain</span>
          <select
        ...
        {/* Sub-Topic Selection */}
        <div className="flex-1 min-w-[170px] flex flex-col gap-1.5">
          <span className="text-[10px] font-extrabold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wider">Sub-Topic</span>
          <select
        ...
        {/* Concept Selection */}
        <div className="flex-1 min-w-[170px] flex flex-col gap-1.5">
          <span className="text-[10px] font-extrabold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wider">Concept</span>
          <select
        ...
        <div className="flex-1 min-w-[140px] flex flex-col gap-1.5">
          <span className="text-[10px] font-extrabold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wider">Difficulty</span>
          <select
        ...
        <div className="flex-1 min-w-[140px] flex flex-col gap-1.5">
          <span className="text-[10px] font-extrabold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wider">Company Tag</span>
          <select
        ...
        {/* Status Selection */}
        <div className="flex-1 min-w-[140px] flex flex-col gap-1.5">
          <span className="text-[10px] font-extrabold text-slate-500 dark:text-slate-400 dark:text-slate-500 uppercase tracking-wider">Status</span>
          <select
