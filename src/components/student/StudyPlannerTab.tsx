...
export default function StudyPlannerTab() {
  ...
  return (
    ...
    >
      {/* Top Header Navigation Tabs - Rendered as a sub-header */}
      <div className="flex items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-6">
          <span className="text-lg font-black text-slate-900 dark:text-white uppercase tracking-tight hidden sm:block">
