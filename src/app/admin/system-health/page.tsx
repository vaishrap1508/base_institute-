            ...
            <div className="bg-[#0f1322] border border-[#151c2f] rounded-2xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {platformServices.map((service, idx) => {
                  ...
                  return (
                    <div key={idx} className="p-4 bg-[#070a13] border border-[#151c2f] rounded-xl flex flex-col justify-between space-y-3 hover:border-purple-500/20 transition-all">
                      ...
                      <div>
                        <h4 className="text-xs font-black text-white">{service.name}</h4>
                        <p className="text-[10px] text-slate-400 font-semibold mt-0.5">{service.desc}</p>
                      </div>
                      <div className="flex items-center justify-between text-[10px] pt-2 border-t border-[#151c2f]/50">
                        <span className="text-slate-500 font-bold uppercase">Latency</span>
                        <span className="text-slate-300 font-mono font-bold">{service.latency}</span>
                      </div>
                    </div>
                  );
                })}
