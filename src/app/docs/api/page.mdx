...
Welcome to the API Reference Specifications section. This page compiles the HTTP endpoint definitions, JSON payloads schemas, input data validation criteria, and authorization policies that govern the communication layer of the Kinetic Platform.
