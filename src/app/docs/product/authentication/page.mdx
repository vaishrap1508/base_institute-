...
A detailed guide to Base Institute's identity validation, authorization workflows, role management, and session rules.
...
## Overview
Base Institute uses **Supabase Auth (GoTrue)** to manage account creation and user verification. This authentication flow connects email/password accounts, Google OAuth tokens, and session cookies with Next.js edge middleware.
