...
The database tier of Base Institute is built on top of **Supabase PostgreSQL**. It manages data structures across multiple core areas: user accounts, curriculum domain hierarchies, student solving progress tracking, leaderboard rankings, and creator authoring flows. Relational integrity is enforced at the database level using cascades, triggers, and foreign keys.
