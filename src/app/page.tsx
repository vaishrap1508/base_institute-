          ...
          {[24, 28, 30, 32].map((num) => {
            ...
            return (
              <button
                key={num}
                type="button"
                onClick={() => setSelectedWorkspaceAns(num)}
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          >
            {[
              ...
              { title: '03. Workshops', desc: 'Syllabus Mocks' },
              { title: '04. Assessments', desc: 'Staging Simulator' }
            ].map((phase, idx) => (
              <button
                key={idx}
                type="button"
                onClick={() => {
                  ...
                  const card = document.getElementById(`curriculum-card-${idx}`);
                  if (card) {
                    card.scrollIntoView({ behavior: 'smooth', block: 'center' });
                  }
                }}
                className={`flex-1 min-w-[130px] py-2 px-3 rounded-xl flex flex-col items-center gap-0.5 text-center transition-all duration-300 cursor-pointer ${
                  activeCurriculumPhase === idx 
                    ? 'bg-slate-950 border border-slate-800 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)] scale-[1.03] text-white font-black' 
                    : 'text-slate-450 hover:text-slate-200 border border-transparent'
                }`}
              >
                <span className="text-[10px] tracking-wide">{phase.title}</span>
                <span className="text-[8px] font-bold text-slate-500">{phase.desc}</span>
              </button>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-6 relative">
            ...
            <div className="hidden lg:flex lg:col-span-1 flex-col items-center justify-between relative py-12 select-none h-full min-h-[900px]">
              ...
              <svg className="absolute top-0 bottom-0 left-1/2 w-[4px] h-full bg-transparent -translate-x-1/2 z-10 overflow-visible pointer-events-none">
                <line 
                  x1="50%" 
                  y1="0%" 
                  x2="50%" 
                  y2="100%" 
                  className="stroke-gradient animate-roadmap-flow stroke-blue-500/40" 
                  strokeWidth="2"
                />
              </svg>
              ...
              {[0, 1, 2, 3].map((idx) => {
                ...
                return (
                  <button
                    ...
                    className={`w-9 h-9 rounded-full flex items-center justify-center border-2 text-[10px] font-black z-20 transition-all duration-300 ${
                      isActive 
              ...
              {[
                {
                  ...
                  icon: Users,
                  color: 'hover:border-blue-500/20 hover:shadow-[0_20px_50px_rgba(59,130,246,0.08)] bg-blue-500/0 hover:bg-blue-950/5',
                  glow: 'bg-blue-600/5',
                ...
                },
                {
                  ...
                  icon: Layers,
                  color: 'hover:border-indigo-500/20 hover:shadow-[0_20px_50px_rgba(99,102,241,0.08)] bg-indigo-500/0 hover:bg-indigo-950/5',
                ...
                },
                {
                  ...
                  icon: Code2,
                  color: 'hover:border-purple-500/20 hover:shadow-[0_20px_50px_rgba(168,85,247,0.08)] bg-purple-500/0 hover:bg-purple-950/5',
                ...
                },
                {
                  ...
                  icon: Trophy,
                  color: 'hover:border-emerald-500/20 hover:shadow-[0_20px_50px_rgba(16,185,129,0.08)] bg-emerald-500/0 hover:bg-emerald-950/5',
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-4 z-10 text-left">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-xl bg-slate-900 border border-slate-850 flex items-center justify-center shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:bg-slate-950 ${card.accentColor}`}>
                          <CardIcon className="w-5 h-5" />
                        </div>
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">Phase 0{idx + 1}</span>
                      </div>
